...
/* A phase that throws (bad saved data, a chart edge case) should degrade to a
   recoverable message, not a blank white screen. Resets when the phase changes
   via the resetKey prop. */
class PhaseBoundary extends Component {
  constructor(props) {
    super(props);
    ...
    <div style={{ minHeight: "100vh", background: T.bgAtmo, fontFamily: T.font, color: T.ink, WebkitFontSmoothing: "antialiased" }}>
      <style>{`
        ...
        * { box-sizing: border-box; }
        /* Reset the UA body margin so the app (and its atmospheric background)
           reaches every screen edge — otherwise an 8px frame of the body's
           default background shows around the app, glaring in dark mode. */
      ...
      <header className="no-print" style={{
        ...
        <div style={{ maxWidth: 1760, width: "100%", margin: "0 auto", padding: "0 20px", height: 60, display: "grid", gridTemplateColumns: "1fr auto 1fr", alignItems: "center", gap: 12 }}>
      ...
      <footer className="no-print" style={{ maxWidth: 1760, width: "100%", margin: "0 auto", padding: "0 20px 34px", textAlign: "center" }}>
